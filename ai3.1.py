...
from PyQt5.QtWidgets import (
    ...
    QSlider, QProgressBar, QSizePolicy, QGridLayout, QGroupBox
)
    ...
    def pixel_sort(self, image, direction, criterion, intensity):
        ...
        for i in range(lines):
            ...
            if criterion == 'Brightness':
                ...
                # Intensity as average of max and min RGB values
                max_vals = line.max(axis=1)
                min_vals = line.min(axis=1)
                key = (max_vals + min_vals) / 2
            ...
            if intensity < 1.0:
                ...
                mask = np.random.rand(len(line)) < intensity
...
class PixelSortApp(QMainWindow):
    ...
    def setup_ui(self):
        ...
        sorting_layout.addWidget(sort_button, 0, 0, 1, 2)

        # Sorting Direction
        direction_label = QLabel("Sort Direction:")
        sorting_layout.addWidget(direction_label, 1, 0)
        ...
        sorting_layout.addWidget(horizontal_radio, 1, 1)

        vertical_radio = QRadioButton("Vertical")
        self.direction_group.addButton(vertical_radio)
        sorting_layout.addWidget(vertical_radio, 1, 2)
